...
-- Records of devices
-- ----------------------------
INSERT INTO "public"."devices" VALUES (1, 'Device 1', 48, 32, 'zaCELgL.0imfnc8mVLWwy', NULL);
INSERT INTO "public"."devices" VALUES (2, 'Device 2', 48, 32, '0imfnc8mVLWwsAawjYr4R', NULL);
INSERT INTO "public"."devices" VALUES (3, 'Device 3', 48, 32, 'sAawjYr4Rx-Af50DDqtlxAt', NULL);
...
CREATE TABLE "public"."workspaces" (
  ...
  "id_device" int4 NOT NULL,
  "name" varchar(255) COLLATE "pg_catalog"."default" NOT NULL,
  "workspace_bytes" bytea NOT NULL
)
;
...
SELECT setval('"public"."devices_id_seq"', 3, true);
...
-- ----------------------------
ALTER TABLE "public"."devices" ADD CONSTRAINT "devices_id_active_workspace_fkey" FOREIGN KEY ("id_active_workspace") REFERENCES "public"."workspaces" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- ----------------------------
ALTER TABLE "public"."workspaces" ADD CONSTRAINT "workspaces_id_device_fkey" FOREIGN KEY ("id_device") REFERENCES "public"."devices" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;
